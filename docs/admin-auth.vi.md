...
**Bắt buộc.** Mật khẩu quản trị được đọc từ môi trường chỉ — không bao giờ từ cấu hình được cam kết:
...
Mật khẩu được kiểm tra bằng `hmac.compare_digest()` — một so sánh thời gian không đổi ngăn chặn người quan sát suy ra độ dài hoặc nội dung mật khẩu thông qua phân tích thời gian phản ứng. Ngay cả đối với mật khẩu không hợp lệ, máy chủ cũng thực hiện công việc mật mã giống nhau trước khi từ chối đăng nhập.
